...
// Pin definition for the IO0 button
...
void camCB(void* pvParameters) {
  ...
  for (;;) {
    ...
    // Debug: Print available heap memory
...
void setup() {
  ...
  //  Configure and connect to WiFi using WiFiManager
  WiFiManager wm;
  bool res;
  res = wm.autoConnect("RUSL AI Cam", "12345678"); // password protected ap
...
void handleResetWiFi() {
  ...
  // Reset WiFi settings and restart the WiFiManager portal
  WiFiManager wm;
  wm.resetSettings(); // This resets the Wi-Fi credentials
  Serial.println("WiFi credentials reset, restarting Wi-Fi manager...");
